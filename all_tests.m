...
XY_Z_HSICresults = bootstrap_null(n,numBootstraps,XY_Z_HSICmatrix,alpha,@bootstrap_series,2);
...
XZ_Y_HSICresults = bootstrap_null(n,numBootstraps,XZ_Y_HSICmatrix,alpha,@bootstrap_series,2);
...
YZ_X_HSICresults = bootstrap_null(n,numBootstraps,YZ_X_HSICmatrix,alpha,@bootstrap_series,2);
