...
for j=1:length(dependence_coefficients);
    ...
    for i=1:numexps;
        ...
        [X,Y,Z] = example2(2000,dependence_coefficients(j));%dependence_coefficients(j));
...
saveas(h,'figures/Example10script_with3HSIC.pdf');
saveas(h,'figures/Example10script_with3HSIC.fig');
