...
dependence_coefficients = 0:0.05:0.4;
...
for j=1:length(dependence_coefficients);
    ...
    for i=1:numexps;
        ...
        [X,Y,Z] = example1(2000,dependence_coefficients(j));
...
save('example9script_with3HSIC','tosave_with3HSIC')
...
plot(dependence_coefficients,rejections(:,3),'-o')
plot(dependence_coefficients,rejections(:,4),'-o')
plot(dependence_coefficients,rejections(:,5),'-o')
...
saveas(h,'figures/Example9script_with3HSIC.pdf');
saveas(h,'figures/Example9script_with3HSIC.fig');
